 ...
 */
package pbo2.pkg10116417.latihan60.akatsuki;
...
public class Anggota extends Akatsuki{
    ...
    private final String asalDesa;
    private final String senjata;
    private final String tipeKarakter;
    private final String jurusAndalan;
    private final String tewas;
